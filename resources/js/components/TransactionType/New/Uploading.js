...
const Uploading = () =>{
    ...
    const [disableSubmit, setDisableSubmit] = useState("disabled")
        ...
        <div className="row justify-content-center">
            <div className="w-full">
                ...
                <div className="card">
                    ...
                    {disclaimer === 1 ?<div className="fixed z-100 left-0 top-0 w-full h-full transparent flex flex-col items-center justify-center bg-black/50 bg-opacity-1">
                        ...
                        {appDet.map((det)=>{
                            let year = new Date().getFullYear()
                            return(
                                <form className="pl-5" key={det.id} encType="multipart/form-data" onSubmit={uploadReqs}>
                                    <span>{year}-{det.id}</span>
                                    ...
                                    <input type="file" name="type" id="type" onChange={handleFile} accept="application/pdf,application" className="pl-5 hidden" required/>
                                    <div className="p-1 pl-5"><label htmlFor="type" className={inputFile}>Choose File</label></div>
                                    {type ? 
                                    ...
                                    <input type="file" name="brgy" id="brgy" onChange={handleFile} accept="application/pdf,application" className="pl-5 hidden"/>
                                    ...
                                    <input type="file" name="leasing" id="leasing" onChange={handleFile} accept="application/pdf,application" className="pl-5 hidden" required/>
                                    ...
                                    <input type="file" name="insurance" id="insurance" onChange={handleFile} accept="application/pdf,application" className="pl-5 hidden" required/>
                                    ...
                                    <>
                                        ...
                                        <input type="file" name="franchise" id="franchise" onChange={handleFile} accept="application/pdf,application" className="pl-5 hidden" required={det.franchise === "1" ? true : false}/>
